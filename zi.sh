...
wget https://github.com/Mr-Redbunny/Zivpn-UDP-Server/releases/download/udp-zivpn_1.4.9/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn 1> /dev/null 2> /dev/null
